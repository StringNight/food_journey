...
class AIServiceClient:
    ...
    def __init__(self):
        ...
        self.chat_client = Client(
            os.getenv("CHAT_SERVICE_URL", "https://27c4F66e5a757cbc13.gradio.live/")
        )
        self.voice_client = Client(
            os.getenv("VOICE_SERVICE_URL", "https://27c4F66e5a757cbc13.gradio.live/")
        )
        self.food_client = Client(
            os.getenv("FOOD_SERVICE_URL", "https://27c4F66e5a757cbc13.gradio.live/")
        )
