...
class AIServiceClient:
    ...
    def __init__(self):
        ...
        self.chat_client = Client(
            os.getenv("CHAT_SERVICE_URL", "https://bce061925ee7082bc9.gradio.live/")
        )
        self.voice_client = Client(
            os.getenv("VOICE_SERVICE_URL", "https://bce061925ee7082bc9.gradio.live")
        )
        self.food_client = Client(
            os.getenv("FOOD_SERVICE_URL", "https://bce061925ee7082bc9.gradio.live")
        )
